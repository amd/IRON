...
regular_test_cases = [
    ("matrix_vector_mul_128x128_32_1col", "-M 128 -K 128 --columns 1 --tile-size 32"),
    ("matrix_vector_mul_2048x8192_1_1col", "-M 2048 -K 8192 --columns 1 --tile-size 1"),
    ("matrix_vector_mul_8192x2048_4_1col", "-M 8192 -K 2048 --columns 1 --tile-size 4"),
    ("matrix_vector_mul_2048x8192_1_2col", "-M 2048 -K 8192 --columns 2 --tile-size 1"),
    ("matrix_vector_mul_8192x2048_4_2col", "-M 8192 -K 2048 --columns 2 --tile-size 4"),
    ("matrix_vector_mul_2048x8192_1_4col", "-M 2048 -K 8192 --columns 4 --tile-size 1"),
    ("matrix_vector_mul_8192x2048_4_4col", "-M 8192 -K 2048 --columns 4 --tile-size 4"),
    ("matrix_vector_mul_2048x8192_1_8col", "-M 2048 -K 8192 --columns 8 --tile-size 1"),
