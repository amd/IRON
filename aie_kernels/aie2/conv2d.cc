...
/**
 * Depthwise Convolution Kernel - AIE2 (vec width 8)
 * OW-dense pipeline parity with aie2p depthwise.
 */
...
/**
 * Pointwise (1x1) Convolution — AIE2 dense path
 */
 *
 * NCHW: contiguous loads over H*W channel planes with broadcast weight[oc, ic]
 * (see aie2p pointwise for layout rationale). Native vector width 8 bf16.
 *
