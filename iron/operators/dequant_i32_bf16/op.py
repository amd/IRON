...
@dataclass
class DequantI32(MLIROperator):
    """AIE-accelerated dequantization operator (int32 -> bfloat16)"""
    ...
    def __post_init__(self):
        ...
        self.input_size = self.size * 4 + (self.size // self.group_size) * 2
    ...
    def get_kernel_artifacts(self):
        return [
            KernelObjectArtifact(
                f"dequant_i32_bf16_{self.tile_size}.o",
                dependencies=[
                    SourceArtifact(
