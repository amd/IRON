...
from iron.operators.swiglu_front.op import SwiGLUFront
from iron.operators.swiglu_front.reference import generate_golden_reference
...
def test_swiglu_decode(embedding_dim, hidden_dim, aie_context):
    ...
    for name in ("left_swished", "right", "intermediate"):
