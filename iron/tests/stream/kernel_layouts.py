...
layouts declared in :mod:`iron.operators.swiglu_prefill_stream.stream.ops` are that contract. They happen
...
from iron.operators.swiglu_prefill_stream.stream.ops import (  # noqa: E402
    ELTWISE_MUL,
    GEMM,
    SILU,
    elementwise_layouts,
